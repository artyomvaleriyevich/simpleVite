...
const Album = () => {
    return (
        <>
            <section className="tenderBg estimateBg">
                ...
                <div className="container">
                    ...
                    <div className="tender__row">
                        ...
                        <div className="tender__block">
                            ...
                            <p className="tender__price">19 000 тг</p>
                        </div>
                    </div>

                    <div className="block-info">
                        <h2 className="block-info__title">Что включает услуга</h2>
                        <p className="block-info__subtitle">Печать альбома в формате А3</p>
                    </div>

                    <div className="block-profile">
                        <h2 className="block-profile__title">Что вы получаете</h2>
                        <button className="block-profile__btn">
                            <span>
                            ...
                            <div className="block-profile__textBlock">
                                ...
                                <p className="block-profile__subtext">Pdf 2,5 Мб</p>
                            </div>
                        </button>
                    </div>
